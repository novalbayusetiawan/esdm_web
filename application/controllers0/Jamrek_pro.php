...
class Jamrek_Pro extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data["title"][] = "Jamrek Tahap Produksi";
        $data["title"][] = "Index";
        $data["view"] = "jamrek_pro/index";
    ...
    public function change_form()
    {
        ...
        $data["title"][] = "Jamrek Tahap Produksi";
        $data["title"][] = "Edit";
        $data["view"] = "jamrek_pro/change_form";
    ...
    public function dt_show()
    {
        ...
        $response = $this->my_api->get_response("jamrek_pro/dt_show", $params);
        ...
        for ($i = 0; $i < count($result["data"]); $i++){
            ...
            $result["data"][$i]["action"] = "<div class=\"btn-group\">
                ...
                <ul class=\"dropdown-menu pull-right\" role=\"menu\">
                    <li><a href=\"javascript:;\" url-api=\"".base_url("jamrek_pro/get_one?id=$id")."\" class=\"data-edit\">Change</a></li>
                    <li><a href=\"javascript:;\" url-api=\"".base_url("jamrek_pro/delete?id=$id")."\" class=\"data-delete\">Remove</a></li>
                </ul>
            </div>";
        }
    ...
    public function get_one()
    {
        ...
        $response = $this->my_api->get_response("jamrek_pro/get_one", $params);
        echo $response;
    }
    ...
    public function insert()
    {
        ...
        $connected = @fsockopen(preg_replace(array("/https?:\/\//i", "/\/.*/i"), "", $server_api), 80);
        ...
        if ($connected) {
            ...
            $this->my_api->set_app_id($app_id);
            $this->my_api->set_app_token($app_token);
            $response = $this->my_api->get_response("jamrek_pro/insert", $params);
    ...
    public function update()
    {
        ...
        if ($connected) {
            ...
            $this->my_api->set_app_id($app_id);
            $this->my_api->set_app_token($app_token);
            $response = $this->my_api->get_response("jamrek_pro/update", $params);
    ...
    public function delete()
    {
        ...
        if ($connected) {
            ...
            $this->my_api->set_app_id($app_id);
            $this->my_api->set_app_token($app_token);
            $response = $this->my_api->get_response("jamrek_pro/delete", $params);
