...
class Jamkes extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data["title"][] = "Jaminan Kesungguhan";
        $data["title"][] = "Index";
        $data["view"] = "jamkes/index";
    ...
    public function dt_show()
    {
        ...
        $response = $this->my_api->get_response("jamkes/dt_show", $params);
        ...
        for ($i = 0; $i < count($result["data"]); $i++){
            ...
            $result["data"][$i]["action"] = "<div class=\"btn-group\">
                ...
                <ul class=\"dropdown-menu pull-right\" role=\"menu\">
                    <li><a href=\"javascript:;\" url-api=\"".base_url("jamkes/get_one?id=$id")."\" class=\"data-edit\">Change</a></li>
                    <li><a href=\"javascript:;\" url-api=\"".base_url("jamkes/delete?id=$id")."\" class=\"data-delete\">Remove</a></li>
                </ul>
            </div>";
        }
    ...
    public function get_one()
    {
        ...
        $response = $this->my_api->get_response("jamkes/get_one", $params);
        echo $response;
    }
    ...
    public function insert()
    {
        ...
        if ($connected) {
            ...
            $this->my_api->set_app_id($app_id);
            $this->my_api->set_app_token($app_token);
            $response = $this->my_api->get_response("jamkes/insert", $params);
    ...
    public function update()
    {
        ...
        if ($connected) {
            ...
            $this->my_api->set_app_id($app_id);
            $this->my_api->set_app_token($app_token);
            $response = $this->my_api->get_response("jamkes/update", $params);
    ...
    public function delete()
    {
        ...
        if ($connected) {
            ...
            $this->my_api->set_app_id($app_id);
            $this->my_api->set_app_token($app_token);
            $response = $this->my_api->get_response("jamkes/delete", $params);
