        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
              <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
                  <i class="fa fa-phone-o"></i> <span class="hidden-xs">Hubungi Kami</span>
              </a>
              <ul class="dropdown-menu animated fadeInLeft">
                  <li><a href="http://www.dinarproject.com" target="_blank" >Dinar Energi Utama</a></li>
              </ul>
            </li>
            <li class="dropdown navbar-user">
                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
                    <!-- <img src="<?php echo base_url("assets/img/gear-user.png"); ?>" alt="" /> -->
                    <span class="hidden-xs"><?php echo ucwords($this->session->userdata("acc_level")); ?></span> <i class="fa fa-caret-down"></i>
                </a>
                <ul class="dropdown-menu animated fadeInLeft">
