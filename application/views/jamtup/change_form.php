    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="nav nav-pills">
                ...
                <li class="active"><a href="<?php echo base_url("jamtup/change_form?id={$id}"); ?>">Jaminan Penutupan</a></li>
        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    <h4 class="panel-title">Jaminan Penutupan <?php echo $nama_perusahaan; ?></h4>
                </div>
