...
$(document).ready(function(){
    ...
    oTable = $("#example").DataTable({
        ...
        "serverSide": true,
        "serverMethod": "POST",
        "ajax":"<?php echo base_url("jamkes/dt_show?id_perusahaan={$id}"); ?>",
        "columns": [
            {"data": "id"},
...
<?php $this->load->view("jamkes/add"); ?>
<?php $this->load->view("jamkes/edit"); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="nav nav-pills">
                ...
                <li class="active"><a href="<?php echo base_url("jamkes/change_form?id={$id}"); ?>">Jaminan Kesungguhan Eksplorasi</a></li>
