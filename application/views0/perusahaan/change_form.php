...
$(document).ready(function(){
    ...
    request.done(function(json){
        ...
        $("#form_edit").find("input[name=nama_ktt]").val(json.result.nama_ktt);
        $("#form_edit").find("input[name=hp_ktt]").val(json.result.hp_ktt);
        $("#form_edit").find("input[name=email_ktt]").val(json.result.email_ktt);
        $("#form_edit").find("input[name=sk_ktt]").val(json.result.sk_ktt);
        ...
        $("#form_edit").find("input[name=no_akta]").val(json.result.no_akta);
        $("#form_edit").find("input[name=no_kenapajak]").val(json.result.no_kenapajak);
        $("#form_edit").find("input[name=no_dagang]").val(json.result.no_dagang);
        $("#form_edit").find("input[name=no_kelayakan]").val(json.result.no_kelayakan);
        $("#form_edit").find("input[name=no_manfaatbbc]").val(json.result.no_manfaatbbc);
        $("#form_edit").find("input[name=no_handak]").val(json.result.no_handak);
        $("#form_edit").find("input[name=no_campur]").val(json.result.no_campur);
        $("#form_edit").find("input[name=no_izinlj]").val(json.result.no_izinlj);
        $("#form_edit").find("input[name=no_cnc]").val(json.result.no_cnc);
        $("#form_edit").find("input[name=no_npwp]").val(json.result.no_npwp);
        $("#form_edit").find("input[name=no_tdper]").val(json.result.no_tdper);
        $("#form_edit").find("input[name=no_ho]").val(json.result.no_ho);
        $("#form_edit").find("input[name=no_limbah]").val(json.result.no_limbah);
        $("#form_edit").find("input[name=no_bbc]").val(json.result.no_bbc);
        $("#form_edit").find("input[name=no_pelabuhan]").val(json.result.no_pelabuhan);
        $("#form_edit").find("input[name=no_ujp]").val(json.result.no_ujp);
        $("#form_edit").find("input[name=no_setling]").val(json.result.no_setling);
        $("#form_edit").find("input[name=no_domisili]").val(json.result.no_domisili);
        $("#form_edit").find("input[name=no_pajak]").val(json.result.no_pajak);
        $("#form_edit").find("input[name=no_eksport]").val(json.result.no_eksport);
        $("#form_edit").find("input[name=no_air]").val(json.result.no_air);
        $("#form_edit").find("input[name=no_gudang]").val(json.result.no_gudang);
        $("#form_edit").find("input[name=no_kawasan]").val(json.result.no_kawasan);
        $("#form_edit").find("input[name=no_opkhusus]").val(json.result.no_opkhusus);
        $("#form_edit").find("input[name=no_lingkungan]").val(json.result.no_lingkungan);
        $("#form_edit").find("input[name=no_jamrekeks]").val(json.result.no_jamrekeks);
        $("#form_edit").find("input[name=no_jaminankesungguhan]").val(json.result.no_jaminankesungguhan);
        $("#form_edit").find("input[name=no_fs]").val(json.result.no_fs);
        $("#form_edit").find("input[name=no_rp]").val(json.result.no_rp);
        $("#form_edit").find("input[name=no_jamrekpro]").val(json.result.no_jamrekpro);
        $("#form_edit").find("input[name=no_iuran]").val(json.result.no_iuran);
        $("#form_edit").find("input[name=no_amdal]").val(json.result.no_amdal);
        $("#form_edit").find("input[name=no_rkttl]").val(json.result.no_rkttl);
        $("#form_edit").find("input[name=no_jamtup]").val(json.result.no_jamtup);
        $("#form_edit").find("input[name=no_royalti]").val(json.result.no_royalti);
        $("#form_edit").find("input[name=no_rr]").val(json.result.no_rr);
        $("#form_edit").find("input[name=no_rkab]").val(json.result.no_rkab);
    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="nav nav-pills">
                ...
                <li class=""><a href="<?php echo base_url("jamtup/change_form?id={$id}"); ?>">JamTup</a></li>
        ...
        <div class="col-md-4">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <div class="col-md-12">
                        <div class="form-group">
                          <label class="control-label">Sama Komoditas</label>
                            <select class="form-control selectpicker m-b-0" name="komoditas_sama">
                              <option value="">Pilih</option>
                            </select>
                        </div>
                        <div class="form-group">
                          <label class="control-label">Wilayah Administrasi</label>
                            <select class="form-control selectpicker m-b-0" name="wadm">
                              <option value="">Pilih Wilayah</option>
                            </select>
                        </div>
                        <div class="form-group">
                          <label class="control-label">Wilayah Pencadangan Negara</label>
                            <select class="form-control selectpicker m-b-0" name="wpa">
                              <option value="">Pilih Wilayah</option>
                            </select>
                        </div>
                    </div>
        ...
        <div class="col-md-4">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <div class="col-md-12">
                        <div class="form-group">
                          <label class="control-label">Kordinat Format Geografis</label>
                            <select class="form-control selectpicker m-b-0" name="komoditas_sama">
                              <option value="">Pilih Kordinat</option>
                            </select>
                        </div>
                        <div class="form-group">
                          <label class="control-label">Kordinat Format IUP Eksplorasi</label>
                            <select class="form-control selectpicker m-b-0" name="wadm">
                              <option value="">Pilih Kordinat</option>
                            </select>
                        </div>
                        <div class="form-group">
                          <label class="control-label">Kordinat Format IUP Produksi</label>
                            <select class="form-control selectpicker m-b-0" name="wpa">
                              <option value="">Pilih Kordinat</option>
                            </select>
                        </div>
