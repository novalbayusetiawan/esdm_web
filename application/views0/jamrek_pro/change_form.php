...
$(document).ready(function(){
    ...
    oTable = $("#example").DataTable({
        ...
        "serverSide": true,
        "serverMethod": "POST",
        "ajax":"<?php echo base_url("jamrek_pro/dt_show?id_perusahaan={$id}"); ?>",
        "columns": [
            {"data": "id"},
...
<?php $this->load->view("jamrek_pro/add"); ?>
<?php $this->load->view("jamrek_pro/edit"); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="nav nav-pills">
                ...
                <li class="active"><a href="<?php echo base_url("jamrek_pro/change_form?id={$id}"); ?>">Jamrek Tahap Produksi</a></li>
