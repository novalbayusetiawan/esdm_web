...
$(document).ready(function(){
    ...
    oTable = $("#example").DataTable({
        ...
        "serverSide": true,
        "serverMethod": "POST",
        "ajax":"<?php echo base_url("jamrek_eks/dt_show?id_perusahaan={$id}"); ?>",
        "columns": [
            {"data": "id"},
...
<?php $this->load->view("jamrek_eks/add"); ?>
<?php $this->load->view("jamrek_eks/edit"); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="nav nav-pills">
                ...
                <li class="active"><a href="<?php echo base_url("jamrek_eks/change_form?id={$id}"); ?>">Jamrek Tahap Eksplorasi</a></li>
                <li><a href="<?php echo base_url("jamrek_pro/change_form?id={$id}"); ?>">Jamrek Tahap Produksi</a></li>
                <li><a href="<?php echo base_url("jamtup/change_form?id={$id}"); ?>">JamTup</a></li>
                <li><a href="<?php echo base_url("jamrek_eks/change_form?id={$id}"); ?>">Jaminan Kesungguhan Eksplorasi</a></li>
                <li><a href="<?php echo base_url("iuran/change_form?id={$id}"); ?>">Iuran Tetap</a></li>
                <li><a href="<?php echo base_url("royalti/change_form?id={$id}"); ?>">Royalti</a></li>
            </ul>
        </div>
    </div>
    <div class="row">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-toolbar clearfix">
                    ...
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-primary data-add"><i class="fa fa-add"></i> Add</button>
