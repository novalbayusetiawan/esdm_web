...
<?php $this->load->view("jamtup/add"); ?>
<?php $this->load->view("jamtup/edit"); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="nav nav-pills">
                ...
                <li class="active"><a href="<?php echo base_url("jamtup/change_form?id={$id}"); ?>">JamTup</a></li>
        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    <h4 class="panel-title">JamTup <?php echo $nama_perusahaan; ?></h4>
                </div>
