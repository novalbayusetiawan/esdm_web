...
$(document).ready(function(){
    ...
    oTable = $("#example").DataTable({
        ...
        "serverSide": true,
        "serverMethod": "POST",
        "ajax":"<?php echo base_url("iuran/dt_show?id_perusahaan={$id}"); ?>",
        "columns": [
            {"data": "id"},
...
<?php $this->load->view("iuran/add"); ?>
<?php $this->load->view("iuran/edit"); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="nav nav-pills">
                ...
                <li class="active"><a href="<?php echo base_url("iuran/change_form?id={$id}"); ?>">Iuran Tetap</a></li>
